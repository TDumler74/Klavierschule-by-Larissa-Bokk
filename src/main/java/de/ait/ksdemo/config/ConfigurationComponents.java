package de.ait.ksdemo.config;

import de.ait.ksdemo.dto.StandardResponseDto;
...
import static de.ait.ksdemo.config.OpenApiDocumentation.*;
/**
 * 05.11.2023
 * ks-demo
 *
...
public class ConfigurationComponents {
    ...
    public OpenAPI openApi() {
        ...
        return new OpenAPI()
                ...
                .info(new Info().title("KS Service API").version("0.1"));
    }
}